<%@page import="com.nackjoon.nj.core.util.FormatUtil"%>
...
<%
        ...
        if("".equals(FormatUtil.toString(request.getParameter("nick")))){
        	if(memberEmail == null) {
                memberEmail = "비회원";
            }	
        }else{
        	
        	memberEmail=FormatUtil.toString(request.getParameter("nick"));
        }
...
/*      var url = "ws://192.168.6.100:8080/controller/chat/";
     ...
     var url = "ws://192.168.0.69:8080/chat/";
    var webSocket = null;
